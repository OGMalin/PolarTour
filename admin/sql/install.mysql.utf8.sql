...
CREATE TABLE `#__polartour_tournament` (
  ...
  `tiebreak1` int(11) NOT NULL DEFAULT '0',
  `tiebreak2` int(11) NOT NULL DEFAULT '0',
  `tiebreak3` int(11) NOT NULL DEFAULT '0',
  `tiebreak4` int(11) NOT NULL DEFAULT '0',
  `tiebreak5` int(11) NOT NULL DEFAULT '0',
